<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:62:"E:\GitHub\vote\public/../application/web\view\index\index.html";i:1519804329;}*/ ?>
<!doctype html>
<html lang="en">
					...
					<div class="mui-scroll">
						...
						<ul class="mui-table-view mui-grid-view mui-grid-9" style="padding: 0;" id="jiu">
							<li class="mui-table-view-cell mui-media mui-col-xs-4 mui-col-sm-4">
								<a href="<?php echo url('qunying/index'); ?>">
									<!--<span class="mui-icon mui-icon-home"></span>-->
							...
							<li class="mui-table-view-cell mui-media mui-col-xs-4 mui-col-sm-4">
								<a href="#" class="wu">
									...
									<div class="mui-media-body">商城贸易</div>
								</a>
							</li>
							<li class="mui-table-view-cell mui-media mui-col-xs-4 mui-col-sm-4">
								<a href="<?php echo url('gold/index'); ?>">
									<!-- <span class="mui-icon mui-icon-location"></span>-->
		...
		<script type="text/javascript">
			...
			function pullupRefresh() {
				setTimeout(function() {
					...
					var cells = document.body.querySelectorAll('#card1 .mui-table-view');
					var table2 = document.body.querySelector('#card2');
					var cells2 = document.body.querySelectorAll('#card2 .mui-table-view');


					for(var i = cells.length, len = i + 4; i < len; i++) {
						var li = document.createElement('div');
						li.className = 'mui-card';
						li.innerHTML = '<a href="<?php echo url('index/info'); ?>"><div class="mui-card-content"><img src="__WEB__/img/painting/gs/u=1012637593,3984533236&fm=27&gp=0.jpg" /></div><div class="mui-card-footer">名称</div></a>';
						var b = i % 2;
						if(b==0){
