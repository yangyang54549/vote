<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:58:"E:\GitHub\vote\public/../application/web\view\pay\pay.html";i:1519642553;}*/ ?>
<!doctype html>
<html lang="en">
...
header>.div {
	...
	<body>
		...
		<div class="mui-off-canvas-wrap mui-draggable">
			...
			<div class="mui-inner-wrap">
				...
				<header class="mui-bar mui-bar-nav">
					...
					<a class=" mui-pull-right mui-btn-link as" href="<?php echo url('pay/paylog'); ?>">充值记录</a>
				</header>
						...
						<form class="mui-input-group" style="margin: 10px;">
							...
							<div class="mui-input-row">
								...
								<div class="mui-input-row mui-checkbox" style="width: 75%; position: absolute; top: 0;right: 0;">
									...
									<input name="checkbox1" id="checkbox" value="Item 1" type="checkbox" checked style="margin-top: 10px;">
								</div>
							</div>
							...
							<div class="mui-input-row" style="height: auto;">
								...
								<p style="margin: 10px; ">
									温馨提示：当您的充值用途不是购买时，7个自然日内我们不支持提现，7个自然日之后您申请提现时我们将收取0.6%的手续费哦∩_∩。
								</p>
							</div>
						</form>
		...
		<script type="text/javascript">
			...
			mui('.mui-input-row').on('tap', '.mui-checkbox', function() {
				var ths = document.getElementById("zf");
				/*if(ths.innerText == "微信支付") {
					ths.innerText = "支付包支付";
				} else {
					ths.innerText = "微信支付";
				}*/
