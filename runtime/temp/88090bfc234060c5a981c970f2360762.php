<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:61:"E:\GitHub\vote\public/../application/web\view\index\info.html";i:1519639646;}*/ ?>
<!doctype html>
<html lang="en">
						...
						<ul class="mui-media "  id="mui-media" style="padding: 0;">
							...
							<div class="mui-card" id="ones">
								...
								<div class="mui-card-content">
									<a href="#"><img src="__WEB__/img/painting/gh/faedab64034f78f0aab4203a73310a55b2191cbf.jpg" data-preview-src="" data-preview-group="2" data-content="这里是文字说明"/></a>
								</div>
								<!--页脚，放置补充信息或支持的操作-->
								...
								<!--<div class="spans"><span class="mui-icon mui-icon-checkmarkempty"></span> </div>-->
...
//					var table = document.body.querySelector('#mui-media');
//					var cells = document.body.querySelectorAll('#mui-media .mui-card');
//
//					for(var i = cells.length, len = i + 4; i < len; i++) {
//						var li = document.createElement('div');
//						li.className = 'mui-card';
//						li.innerHTML = '<div class="mui-card-content"><a href="#"><img src="__WEB__/img/painting/gh/timg (12).jpg"data-preview-src="" data-preview-group="1"/></a></div><div class="mui-media-body" style="padding: 10px;">名家字画<p style="text-indent:2em;"> 吴败，字国旗，号画魔,云南江川人。4岁学习书画，其人画画成魔，15年不出家门。读周易，悟太极，理解宇宙变化原理，融和中国传统山水，花鸟。启功先生观其书画，书赠“少年老成”四字，既表认同，更多激励。中国艺术大师朱纪瞻先生在上海为吴败题写了“滇南鬼才”四字，以奖励后生。</p></div>';
...
swiperight: true
    ...
    mui.init({ keyEventBind: { backbutton: true //打开back按键监听
    } }); mui.back = function () {
    	var btn = ["确定", "取消"];
    	mui.confirm('确认关闭当前窗口？', '提示', btn, function (e) { if (e.index 。*/
