<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"E:\GitHub\vote\public/../application/web\view\qunying\index.html";i:1519812251;}*/ ?>
<!doctype html>
<html lang="en">
							...
							<ul class=" mui-media mui-col-xs-6 mui-col-sm-6" id="card1">
								...
								<div class="mui-card" id="ones">
									...
									<div class="mui-card-content">
										<a href="<?php echo url('qunying/info'); ?>"><img src="__WEB__/img/painting/gh/faedab64034f78f0aab4203a73310a55b2191cbf.jpg" /></a>
									</div>
									<!--页脚，放置补充信息或支持的操作-->
									<div class="mui-card-footer">名称</div>
<!--<div class="spa"><span class=" mui-icon mui-icon-email "></span><span class="">123</span><span class="">枚</span></div>-->
									<div class="spans"><span class="">点赞</span> </div>
								...
								<div class="mui-card">
									...
									<!--内容区-->
									<div class="mui-card-content">
										<a href="<?php echo url('qunying/info'); ?>"><img src="__WEB__/img/painting/gh/timg (15).jpg" /></a>
									</div>
									<!--页脚，放置补充信息或支持的操作-->
									<div class="mui-card-footer">名称</div>
									<!--<div class="spa"><span class=" mui-icon mui-icon-email "></span><span class="">123</span><span class="">枚</span></div>-->
								...
								<div class="mui-card">
									...
									<!--内容区-->
									<div class="mui-card-content">
										<a href="<?php echo url('qunying/info'); ?>"><img src="__WEB__/img/painting/gh/timg (1).jpg" /></a>
									</div>
									<!--页脚，放置补充信息或支持的操作-->
									<div class="mui-card-footer">名称</div>
									<!--<div class="spa"><span class=" mui-icon mui-icon-email "></span><span class="">123</span><span class="">枚</span></div>-->
								...
								<div class="mui-card">
									...
									<!--内容区-->
									<div class="mui-card-content">
										<a href="<?php echo url('qunying/info'); ?>"><img src="__WEB__/img/painting/gh/timg (10).jpg" /></a>
									</div>
									<!--页脚，放置补充信息或支持的操作-->
									<div class="mui-card-footer">名称</div>
									<!--<div class="spa"><span class=" mui-icon mui-icon-email "></span><span class="">123</span><span class="">枚</span></div>-->
								...
								<div class="mui-card">
									...
									<!--内容区-->
									<div class="mui-card-content">
										<a href="<?php echo url('qunying/info'); ?>"><img src="__WEB__/img/painting/gh/timg (12).jpg" /></a>
									</div>
									<!--页脚，放置补充信息或支持的操作-->
									<div class="mui-card-footer">名称</div>
									<!--<div class="spa"><span class=" mui-icon mui-icon-email "></span><span class="">123</span><span class="">枚</span></div>--><div class="spans"><span class="">点赞</span> </div>
							...
							<ul class="mui-media mui-col-xs-6 mui-col-sm-6" id="card2">
								<div class="mui-card">
									...
									<!--内容区-->
									<div class="mui-card-content">
										<a href="<?php echo url('qunying/info'); ?>"><img src="__WEB__/img/painting/gh/timg (16).jpg" /></a>
									</div>
									<!--页脚，放置补充信息或支持的操作-->
									<div class="mui-card-footer">名称</div>
									<!--<div class="spa"><span class=" mui-icon mui-icon-email "></span><span class="">123</span><span class="">枚</span></div>-->
								...
								<div class="mui-card">
									...
									<!--内容区-->
									<div class="mui-card-content">
										<a href="<?php echo url('qunying/info'); ?>"><img src="__WEB__/img/painting/gh/timg (6).jpg" /></a>
									</div>
									<!--页脚，放置补充信息或支持的操作-->
									<div class="mui-card-footer">名称</div>
									<!--<div class="spa"><span class=" mui-icon mui-icon-email "></span><span class="">123</span><span class="">枚</span></div>-->
								...
								<div class="mui-card">
									...
									<!--内容区-->
									<div class="mui-card-content">
										<a href="<?php echo url('qunying/info'); ?>"><img src="__WEB__/img/painting/gh/timg (8).jpg" /></a>
									</div>
									<!--页脚，放置补充信息或支持的操作-->
									<div class="mui-card-footer">名称</div>
									<!--<div class="spa"><span class=" mui-icon mui-icon-email "></span><span class="">123</span><span class="">枚</span></div>-->
								...
								<div class="mui-card">
									...
									<!--内容区-->
									<div class="mui-card-content">
										<a href="<?php echo url('qunying/info'); ?>"><img src="__WEB__/img/painting/gr/timg (26).jpg" /></a>
									</div>
									<!--页脚，放置补充信息或支持的操作-->
									<div class="mui-card-footer">名称</div>
									<!--<div class="spa"><span class=" mui-icon mui-icon-email "></span><span class="">123</span><span class="">枚</span></div>-->
								...
								<div class="mui-card">
									...
									<!--内容区-->
									<div class="mui-card-content">
										<a href="<?php echo url('qunying/info'); ?>">
											<img src="__WEB__/img/painting/gs/u=1012637593,3984533236&fm=27&gp=0.jpg" /></a>
									</div>
									<!--页脚，放置补充信息或支持的操作-->
									<div class="mui-card-footer">名称</div>
									<!--<div class="spa"><span class=" mui-icon mui-icon-email "></span><span class="">123</span><span class="">枚</span></div>-->
			...
			function pullupRefresh() {
				setTimeout(function() {
					...
					for(var i = cells.length, len = i + 4; i < len; i++) {
						...
						li.innerHTML = '<div class="mui-card-content"><a href="<?php echo url('qunying/info'); ?>"><img src="__WEB__/img/painting/gr/timg (26).jpg" /></a></div><div class="mui-card-footer">名称</div><div class="spans"><span class="">点赞</span> </div>';
						var b = i % 2;
						if(b==0){
...
//			})(mui);
			...
			mui("#card ").on("tap", ".mui-media .mui-card .spans span", function() {
				...
				/*mui.toast(this.parentNode.parentNode.parentNode.className);*/
				// var  ts = $$(".mui-table-view .mui-card").index(this.parentNode.parentNode);


				/* mui.toast(this.parentNode.previousSibling.innerText);*/
				if(tt >1) {
